...
.placename.medium[place='small_town'][zoom>9][zoom<16]{
  text-face-name:@font_reg;
  text-name:"[name]";
  text-fill:@sr_text_fill; //#555;
  text-halo-fill:@sr_text_halo_fill; //#fff;
  text-halo-radius:2;
  [zoom=8] { text-size:10; text-halo-radius:1; }
...
.highway-label[zoom>11] {
  ...
  [highway='motorway'][zoom>=12] {
    text-name:"[name]";
    text-fill: @sr_text_fill; //spin(darken(@motorway_fill,70),-15);
    text-halo-fill: @sr_text_halo_fill; //lighten(@motorway_fill,8);
  ...
  [highway='trunk'][zoom>=12] {
    text-name:"[name]";
    text-fill: @sr_text_fill; //spin(darken(@trunk_fill,66),-15);
    text-halo-fill: @sr_text_halo_fill; //lighten(@trunk_fill,8);
    [zoom>=15] { text-size:11; }
    [zoom>=17] { text-size:12; }
  }
  [highway='primary'][zoom>=13] {
    text-name:"[name]";
    text-fill: @sr_text_fill; //spin(darken(@primary_fill,66),-15);
    text-halo-fill: @sr_text_halo_fill; //lighten(@primary_fill,8);
    [zoom>=15] { text-size:11; }
    [zoom>=17] { text-size:12; }
  }
  [highway='secondary'][zoom>=13] {
    text-name:"[name]";
    text-fill: @sr_text_fill; //spin(darken(@secondary_fill,66),-15);
    text-halo-fill: @sr_text_halo_fill; //lighten(@secondary_fill,8);
    [zoom>=15] { text-size:11; }
    [zoom>=17] { text-size:12; }
  }
